...
const PARAGRAPHS = [
  `In this body of work, I bring together music and painting to tell a single story—the story of The Umberman. He's unsure and unmoored, but he's in love, too. He struggles with a hero complex while somewhat paranoid. And, like most other 30-somethings, he's overworked and still can't afford a mortgage. He feels betrayed by the generation before him and is mortified to have children for fear of not measuring up either. He's sometimes steeped in dread, others an eternal optimist. He believes his destiny is tied to his choices and, at the same time, knows there are neural pathways threaded before his umbilical cord was snipped and buried. Or eaten. Or whatever.`,
  `His concerns are universal: love, doubt, grief, displacement, and a yearning to be rooted, to belong somewhere; lingering questions that remain unanswered regardless of our origins or beliefs. Each song and painting records snapshots from different moments in life, but together they ask how we find meaning while living through uncertainty.`,
  ...
  `Come in, have a look, bring what you'll bring and take all you can. I hope the taking is good. If it isn't, I'll just stick to painting portraits — after 77 times 7 more tries.`,
] as const;
