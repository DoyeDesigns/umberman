...
type AboutExhibitionSectionProps = {
  design?: PageDesign;
};

export function AboutExhibitionSection({ design = "alt" }: AboutExhibitionSectionProps) {
  ...
  return (
    ...
    >
      <div className="section-px mx-auto w-full max-w-[min(100%,52rem)] py-[clamp(3rem,8vw,5.5rem)]">
        ...
        <div className="flex flex-col gap-[clamp(1rem,2.5vw,1.5rem)] text-center font-body text-[clamp(0.875rem,2vw,1.125rem)] font-normal leading-[1.4] tracking-normal text-[#1C1C1C] md:leading-[1.38]">
